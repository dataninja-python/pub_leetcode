...
const monies = [[1, 2, 3], [4, 5, 6], [2, 5, 8]];

const getCustomer = (mainArray) => {
  let wealthiestCustomer = 0;
  // returns each customers bank accounts
  for (let customerIndex = 0; customerIndex < mainArray.length; customerIndex++) {
    // console.log(mainArray[customerIndex]);
    let customerBankAccounts = mainArray[customerIndex];
    // console.log(customerBankAccounts);
    ...
    for (let bankIndex = 0; bankIndex < customerBankAccounts.length; bankIndex++) {
...
let richest = getCustomer(monies);
console.log('====================================');
console.log(richest);
console.log('====================================');